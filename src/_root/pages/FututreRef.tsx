    ...
    <div class="track" id="track">
      ...
      <article class="project-card" active>
        ...
        <div class="project-card__content">
          ...
          <div>
            <h3 class="project-card__title">Socials</h3>
            <p class="project-card__desc">@mwiregi on all platforms</p>
            <button class="project-card__btn">follow</button>
          </div>
        </div>
      </article>
      ...
      <article class="project-card">
        ...
        <div class="project-card__content">
          ...
          <div>
            <h3 class="project-card__title">Occupation</h3>
            <p class="project-card__desc">Crurrently working at Safaricom plc</p>
            <button class="project-card__btn">SAFARICOM/CFO.</button>
          </div>
        </div>
      </article>
      ...
      <article class="project-card">
        ...
        <div class="project-card__content">
          ...
          <div>
            <h3 class="project-card__title">Music Genre</h3>
            <p class="project-card__desc">CAN GET OVER THIS PLAYLIST</p>
            <button class="project-card__btn">PLAY</button>
          </div>
        </div>
      </article>
      ...
      <article class="project-card">
        ...
        <div class="project-card__content">
          ...
          <div>
            <h3 class="project-card__title">Brand</h3>
            <p class="project-card__desc">Founder & CEO at Block 7</p>
            <button class="project-card__btn">My Net Worth</button>
          </div>
        </div>
      </article>
      ...
      <article class="project-card">
        ...
        <div class="project-card__content">
          ...
          <div>
            <h3 class="project-card__title">Cataloque</h3>
            <p class="project-card__desc">Selling brainstorming ideas  </p>
            <button class="project-card__btn">@1k / 5mins brainstormin</button>
          </div>
        </div>
      </article>
